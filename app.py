        ...
        try:
            if imageURL == '':
                ...
                if (len(a) == 0):
                    ...
                    data_word = (
                    str(bookname.encode('utf-8')), str(authorname.encode('utf-8')), str(year), str(imageURL), str(read),
                    str(favorite), str(toberead))
                ...
                if ret.code == 200:
                    ...
                    if (len(a) == 0):
                        ...
                        data_word = (
                        str(bookname.encode('utf-8')), str(authorname.encode('utf-8')), str(year), str(new_url),
                        str(read), str(favorite), str(toberead))
